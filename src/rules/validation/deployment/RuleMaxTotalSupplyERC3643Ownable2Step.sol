 ...
 * @notice {RuleMaxTotalSupplyOwnable2Step} for **ERC-3643 tokens only**. Identical supply-cap logic; the sole
 ...
 * plain {RuleMaxTotalSupplyOwnable2Step}.
 *
 ...
 *
 * @dev Composes with {RuleChainlinkPoRERC3643Ownable2Step} exactly as the CMTAT pair does: the Proof-of-Reserve
