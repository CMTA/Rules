...
The delta from `v0.5.0` is **+10 instances** (336 → 346) on **+204 nSLOC**, entirely the five source files added
...
| src/rules/operation/abstract/RuleConditionalTransferLightBase.sol | 149 |
| src/rules/operation/abstract/RuleConditionalTransferLightInvariantStorage.sol | 25 |
| src/rules/operation/abstract/RuleConditionalTransferLightMultiTokenBase.sol | 247 |
