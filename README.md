...
| --- | --- | --- | --- | --- | --- |
| 2026-08-17, commit `01632da` | 0 | 13 | 11 | 0 | **Nothing exploitable** — 1 fixed (NM-3, `v0.6.0`), one documentation item (NM-11) |
...
the previous audit, and the set collapses to about 11 distinct claims. **NM-3 was fixed in `v0.6.0`**: the
...
`transferFrom` and `burnFrom`. The one item still recommended for action is NM-11: the balance and supply cap
